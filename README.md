This Anticheat has been updated by Christiano9590 and is maintain (un-officially) as for now on, all credits goes to Vekster.
README.MD:
# LightAntiCheat
...
<dependency>
  ...
  <version>HotFix-1.2.9</version>
</dependency>
````
Or use the maven dependency with Gradle:
```gradle
dependencies {
    compileOnly 'me.vekster:lightanticheat:HotFix-1.2.9'
}
```
